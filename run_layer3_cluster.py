...
def call_ollama(prompt: str, cfg: dict) -> dict:
    ...
    payload = {
        ...
        "options": {
            ...
            "num_predict":  opts.get("num_predict", 3000),
...
def main():
    ...
    for f in jsons:
        ...
        articles[pmid] = {
            ...
            "governance_implemented_count":  d.get("governance_implemented_count", 0),
            "governance_aspirational_count": d.get("governance_aspirational_count", 0),
            "governance_not_addressed_count": d.get("governance_not_addressed_count", 0),
            "governance_dimensions": d.get("governance_dimensions", {}),
